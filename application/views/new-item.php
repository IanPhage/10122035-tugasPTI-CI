                        ...
                        <div class="box-body">
                            <form id="form-insert-item" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="jml_produk" class="form-control"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.bs-example-modal-sm').on('hidden.bs.modal', function () {
            ...
            $(".bs-example-modal-sm in-put[name='kd_model']").attr("readonly", true);
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.item) {
                        ...
                        $(".bs-example-modal-sm tex-tarea[name='deskripsi']").html(data.item.deskripsi);

                        $('.bs-example-modal-sm').modal('show');

                        $(".bs-example-modal-sm in-put[name='method']").val("edit");
