                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                ...
                                <a href="<?php echo site_url('item'); ?>" class="small-box-footer"> More info <i
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="<?php echo site_url('model'); ?>" class="small-box-footer"> More info <i
                                        class="fa fa-arrow-circle-right"></i>
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                ...
                                <a href="<?php echo site_url('proses'); ?>" class="small-box-footer"> More info <i
                                        class="fa fa-arrow-circle-right"></i>
                        ...
                        <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                ...
                                <a href="<?php echo site_url('rosso'); ?>" class="small-box-footer"> More info <i
                                        class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="<?php echo site_url('balikan'); ?>" class="small-box-footer"> More info <i
                                        class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                ...
                                <a href="<?php echo site_url('oven'); ?>" class="small-box-footer"> More info <i
                                        class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-purple">
                                ...
                                <a href="<?php echo site_url('packing'); ?>" class="small-box-footer"> More info <i
                                        class="fa fa-arrow-circle-right"></i>
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        foreach ($user1->result() as $row) { ?>
                                            ...
                                            <address>
                                                ...
                                                <i class="fa fa-inbox"></i><a href="mailto:<?php echo $row->user_email; ?>"> <?php echo
